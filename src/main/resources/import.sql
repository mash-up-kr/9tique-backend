INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'JACKET', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'COATS', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'JUMPER', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'HOODS_ZIPUP', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'PADDING_JUMPER', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('OUTER', 'VEST', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'TSHIRT', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'HOODS_TSHIRT', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'SLEEVELESS', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'SHIRT', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'KNIT', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'BLOUSE', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('TOP', 'ONE_PIECE', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('BOTTOM', 'DENIM_PANTS', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('BOTTOM', 'PANTS', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('BOTTOM', 'SHORTS', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('BOTTOM', 'SKIRT', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('SHOSE', '', CURRENT_TIMESTAMP(), 'Y');
INSERT INTO category(main, sub, created_at, active) VALUES ('CAP', '', CURRENT_TIMESTAMP(), 'Y');
